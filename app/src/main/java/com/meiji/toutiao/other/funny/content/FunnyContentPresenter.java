...
//        Intent intent = new Intent(InitApp.AppContext, FunnyCommentFragment.class);
//        intent.putExtra(FunnyCommentFragment.GROUP_ID, group_id);
//        intent.putExtra(FunnyCommentFragment.ITEM_ID, item_id);
